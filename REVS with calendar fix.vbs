...
Function create_dynamic_calendar_dialog(selected_dates_array, month_to_use, text_prompt, one_date_only, disable_weekends, disable_month_change, start_date, end_date)
...
month_to_use = DateAdd("M", 1, calendar_month)												'This is the next calendar month (1 month ahead of the date in month_to_use)
...
CALL create_dynamic_calendar_dialog(selected_dates_array, month_to_use, text_prompt, FALSE, TRUE, TRUE, 1, 8)
...
FOR EACH chosen_date IN selected_dates_array
	'These are the dates that the user has determined the agency/unit/worker
	appointment_time = chosen_date & " " & first_appointment_listbox		'putting together the date and time values.
	DO
